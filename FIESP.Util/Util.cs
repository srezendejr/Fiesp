...
namespace FIESP.Util
{
    public static class Util
    {
        ...
        public static string ImageToBase64(this string CaminhoImagem)
        {
            ...
            {
                var img = System.Drawing.Image.FromFile(CaminhoImagem);
                MemoryStream ms = new MemoryStream();
                img.Save(ms, System.Drawing.Imaging.ImageFormat.Bmp);
        ...
        public static MemoryStream ComprimirImagem(System.Drawing.Image imagem, long qualidade, ImageCodecInfo codec)
        {
        ...
        public static System.Drawing.Image EscalaPercentual(System.Drawing.Image imgFoto, int Percentual)
        {
            ...
            System.Drawing.Bitmap bmImagem = new System.Drawing.Bitmap(destWidth, destHeight, PixelFormat.Format24bppRgb);
            ...
            System.Drawing.Graphics grImagem = System.Drawing.Graphics.FromImage(bmImagem);
